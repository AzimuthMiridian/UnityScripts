...
This script is meant to help automate the tedious process of adding custom and ARKit blendshape values to VRM blendshape clips. I built this for my husband and I and thought other people might be able to make use of it, so I'm sharing it here. I recommend you have at least a passing familiarity with Unity, C#, and the VRM export process before using this, or have a friend that can help walk you through it.
